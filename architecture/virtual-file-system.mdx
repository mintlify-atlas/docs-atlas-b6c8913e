---
title: "Virtual File System: In-Memory Storage for NEX OS"
sidebarTitle: "Virtual File System"
description: "NEX OS implements a sandboxed in-memory VFS using React context. Supports create, read, update, delete, and recursive folder operations — no real disk access."
---
