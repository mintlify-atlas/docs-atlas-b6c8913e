---
title: "WindowManager: The NEX OS Kernel for Window Lifecycle"
sidebarTitle: "Window Manager"
description: "How WindowManagerContext manages window state, z-index layering, snap layouts, virtual desktops, and inter-window focus in NEX OS."
---
