...
description: "NEX OS File Explorer provides tree/list views, drag-and-drop, and .nex executable launching — all backed by the in-memory FileSystemContext VFS."
---
