---
title: "NEX OS Quickstart: Clone, Install, and Run Locally"
sidebarTitle: "Quickstart"
description: "Clone, install, and run NEX OS locally with npm. Covers the Vite dev server, WASM compilation, production build, and common troubleshooting steps."
---
