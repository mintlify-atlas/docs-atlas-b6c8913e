...
| Shortcut    | Action                                                    |
| ----------- | --------------------------------------------------------- |
| `Win + W`   | Open or close the **Widgets panel** (Weather, News, Stocks) |

The widgets panel is toggled via `toggleWidgets()` from `useUI()`. It slides in from the left side of the desktop and can also be dismissed by clicking outside of it.

---

## In-App Shortcuts

Many NEX OS applications register their own keyboard shortcuts internally. These are active only when the application window is focused.

| Shortcut         | App                           | Action                                      |
| ---------------- | ----------------------------- | ------------------------------------------- |
| `Ctrl + S`       | Notepad, VS Code (Nex Code), WordPad | Save the current file               |
| `Ctrl + Z`       | Notepad, Paint                | Undo the last action (browser-native undo)  |
| `Ctrl + A`       | Notepad                       | Select all text in the editor               |
| `Ctrl + C`       | All apps                      | Copy selected content                       |
| `Ctrl + V`       | All apps                      | Paste from clipboard                        |
| `Ctrl + Shift + P` | VS Code (Nex Code)          | Open the command palette                    |
| `Ctrl + P`       | VS Code (Nex Code)            | Quick file open                             |
| `` Ctrl + ` ``   | VS Code (Nex Code)            | Toggle the integrated terminal              |
