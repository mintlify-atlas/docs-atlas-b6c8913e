---
title: "useWindowManager() Hook API Reference"
sidebarTitle: "useWindowManager"
description: "Complete API reference for the useWindowManager React hook — the core kernel of NEX OS managing window lifecycle, z-index, snap layouts, and virtual desktops."
---
