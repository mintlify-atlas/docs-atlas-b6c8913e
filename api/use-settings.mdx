---
title: "useSettings() Hook API Reference"
sidebarTitle: "useSettings"
description: "Complete API reference for useSettings — access and mutate NEX OS system preferences including theme, neon overlays, wallpaper, volume, brightness, and system state."
---
